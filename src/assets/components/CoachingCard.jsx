...
const CoachingCard = ({
  ...
  return (
    <div className={`${cardBg} rounded-2xl p-8 shadow-lg max-w-sm mx-auto text-center`}>
      {/* Icon Section */}
      <div className="flex justify-center mb-6">
        <div className="relative">
          {/* Dashed border circle */}
          <div className="w-24 h-24 border-2 border-dashed border-[#2FC7A1] rounded-full absolute -inset-2"></div>
          {/* Icon circle */}
      ...
      {/* Button */}
      <button className={`flex items-center justify-between rounded-full ${buttonBgColor} ${buttonHoverColor} text-white font-medium h-12 pl-8 pr-0 overflow-hidden gap-4 transition-colors duration-200 w-full`}>
